                ...
                <div style="height:80vh" class="d-flex flex-column  justify-content-center">
                    ...
                    <form class="form-signin d-flex flex-column  justify-content-between"
                        ...
                        <div class="form-label-group row text-center d-flex justify-content-center">
                            ...
                            <input class="form-control col-4" name="name" <?php if (isset($_GET['id'])) { ?>
                                value="<?php echo $user['name']; ?> " <?php } ?> required autofocus>
                        </div>

                        <div class="form-label-group row text-center d-flex justify-content-center">
                            <label for="email" class="col-2">Email</label>
                            <input class="form-control col-4" name="email" <?php if (isset($_GET['id'])) { ?>
                                value="<?php echo $user['email']; ?> " <?php } ?> required autofocus>
                        </div>

                        <div class="form-label-group row text-center d-flex justify-content-center">
                            <label for="inputPassword" class="col-2">Password</label>
                            <input type="password" class="form-control col-4" <?php if (isset($_GET['id'])) { ?>
                                value="<?php echo $user['password']; ?> " <?php } ?> placeholder="Password"
                                name="password" required>
                        </div>

                        <div class="form-label-group row text-center d-flex justify-content-center">
                            <label for="image" class="col-2">Image</label>
                            <input type="file" class="form-control-file col-4" name="user" id="user"
                                <?php if (isset($_GET['id'])) { ?>
                                value="./../../../images/users/<?php echo $user['image']; ?>" <?php } ?>>
                        </div>
