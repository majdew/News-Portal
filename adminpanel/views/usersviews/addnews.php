                ...
                <div style="height:80vh" class="d-flex flex-column  justify-content-center">
                    ...
                    <form class="form-signin d-flex flex-column  justify-content-between"
                        ...
                        <div class="form-label-group row text-center d-flex justify-content-center">
                            ...
                            <input type="file" multiple class="form-control-file col-4"
                                <?php if (isset($_GET['id'])) { ?>
                                value="./../../../images/news/<?php echo $new['image']; ?>" <?php } ?> accept="image/*"
                                name="news">
                        </div>
                        ...
                        <div class="form-label-group text-center row d-flex justify-content-center">
                            <div class="col-4 row d-flex justify-content-around">
                                <div class="text-center d-flex justify-content-between">
                                    <label for="urgent" class="col-4">Urgent</label>
                                    <input class="form-check-input" name="isUrgent" value="1" type="checkbox" <?php if (isset($_GET['id'])) {
                                                                                                                    if ($new['isUrgent']) echo "checked";
                                                                                                                    else echo "value='0'";
                                                                                                                } ?>>
                                </div>
                                <div class="form-label-group text-center d-flex justify-content-between">
                                    <label for="global" class="col-4">Global</label>
                                    <input class="form-check-input" name="isGlobal" type="checkbox" <?php if (isset($_GET['id'])) {
                                                                                                                    if ($new['isGlobal']) echo "checked";
                                                                                                                } ?>>
                                </div>
                            </div>
                        </div>
