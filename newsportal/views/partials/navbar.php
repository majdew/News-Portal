<nav class="navbar navbar-expand-lg">
	<a class="navbar-brand" href="#">
		<img src="./../assets/images/sky-news-logo.png" alt="" width="200px" height="50px" />
	</a>
</nav>
<nav class="navbar second-nav navbar-expand-lg border-bottom border-danger">
	<ul class="navbar-nav mr-auto">
		...
		<li class="nav-item">
			<a class="nav-link font-weight-bold" href="#">Important news</a>
		</li>
		<li class="nav-item">
