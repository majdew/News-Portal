...
<body>
	...
	<div class="d-flex flex-row p-2">
		<div class="flex-column d-flex" style="width: 25rem;">
			...
			<div class="border border-danger mt-2 p-2 flex-column" style="width: 18rem;">
			...
			<div class="d-flex">
				<div class="flex-column  md-2">
					...
					<div class="p-2 d-flex border-bottom border-dark">
						...
						<img class="ml-auto" style="width: 5rem; height : 5rem;" src="./../assets/images/<?php echo $new5[4]; ?>" alt="" />
					</div>
				</div>
